...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = 'Test 4: 4 red on blue'
    window = rg.RoseWindow(440, 440, title)
    circle = rg.Circle(rg.Point(300, 400), 25)
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    title = 'PIZZA test 4:  7 slices, black lines, yellow circle.'
...
def run_test_polygon():
    ...
    polygon(window, circle, 10, 'red', 4)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'FANCY POLYGON Test 4: 20 blue segments on yellow circle, hops = 5'
    window = rg.RoseWindow(500, 500, title)

    circle = rg.Circle(rg.Point(100, 150), 60)
    circle.fill_color = 'yellow'
    fancy_polygon(window, circle, 20, 5, 'blue', 4)
    window.close_on_mouse_click()
